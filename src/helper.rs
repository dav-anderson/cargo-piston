...
impl Helper {
    ...
    pub fn gpg_valid(key_id: Option<String>, gpg_bin: Option<String>) -> bool {
        if key_id.is_none() {
            return false
    ...
    pub fn gpg_sign(key_id: Option<String>, key_pass: Option<String>, gpg_path: Option<String>, bundle_path: &PathBuf) -> String{
